...
namespace EmployeeApplication.Migrations
{
    ...
    [Migration("20220515142436_updateemployee2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeApplication.Models.Conge", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EmployeeApplication.Models.User", b =>
                {
            ...
            modelBuilder.Entity("EmployeeApplication.Models.Conge", b =>
                {
                    ...
                    b.HasOne("EmployeeApplication.Models.TypeConge", "TypeConge")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeApplication.Models.Employee", b =>
                {
                    b.HasOne("EmployeeApplication.Models.Contrat", "Contrat")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EmployeeApplication.Models.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
